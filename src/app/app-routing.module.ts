    ...
    children: [
      {
        path: '',
        loadChildren: () =>
          import('./recursos/recursos.module').then(
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./recursos-detalle/recursos-detalle.module').then(
            (m) => m.RecursosDetallePageModule
          ),
      },
      {
        ...
        loadChildren: () =>
          import('./recursos-editar/recursos-editar.module').then(
            (m) => m.RecursosEditarPageModule
          ),
      },
    ],
  },
